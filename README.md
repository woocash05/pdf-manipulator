...
**pdfmanipulator** to proste narzędzie graficzne do łączenia i rozdzielania plików PDF. Skrypt wykorzystuje `bash`, `zenity` oraz `poppler-utils`, umożliwiając użytkownikowi wygodną pracę na plikach PDF bez potrzeby korzystania z terminala.
